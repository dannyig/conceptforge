...
> 1. **Branch check:** run `git branch --show-current` — output must NOT be `main`. If it is, stop. Switch to `feature/QA-01-test-suite` and re-stage changes before committing.
